...
RSpec.describe ProductsController, type: :routing do
  describe "routing" do
    it "routes to #index" do
      expect(get: "/stores/1/products").to route_to("products#index", store_id: "1")
    end

    it "routes to #products_store" do
      expect(get: "/products/store/1").to route_to("products#products_store", store_id: "1")
    end

    it "routes to #listing" do
      expect(get: "/listing").to route_to("products#listing")
    end
